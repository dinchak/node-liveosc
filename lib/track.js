 ...
 * node-liveosc
 *
 * Track object, represents an audio or midi track in 
...
var Track = function (liveosc, id) {
   ...
   * @param  {Number} trackId the id of the track
   * @param  {[type]} arm     0 or 1
   * @param  {[type]} solo    0 or 1
   * @param  {[type]} mute    0 or 1
   * @param  {[type]} audio   0 = midi, 1 = audio
   * @param  {[type]} volume  current track volume
   * @param  {[type]} pan     current track panning
   */

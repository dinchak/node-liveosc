...
var Song = function (liveosc) {
   ...
   * @param  {[type]} scene new scene number
   */
   ...
   * @param  {[type]} numTracks new number of tracks
   */
   ...
   * @param  {[type]} numTracks number of returns
   */
...
Song.prototype.continue = function () {
  this.emitter.emit('/live/play/continue');
};
...
Song.prototype.nextCue = function () {
  this.emitter.emit('/live/next/cue');
};
...
Song.prototype.prevCue = function () {
  this.emitter.emit('/live/prev/cue');
};
...
Song.prototype.view = function () {
  this.emitter.emit('/live/master/view');
};
...
Song.prototype.setVolume = function (volume) {
  this.emitter.emit('/live/master/volume',
    {
      type: 'float',
      value: volume
    }
...
Song.prototype.setPan = function (pan) {
  this.emitter.emit('/live/master/pan',
    {
      type: 'float',
      value: pan
    }
